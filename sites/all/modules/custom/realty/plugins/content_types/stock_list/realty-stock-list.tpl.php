<div class="container-fluid container-fix about-header about-header-bigger" data-speed="3" data-type="background" style="background-image: url(<?php print $background; ?>);">
