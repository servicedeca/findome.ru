<div class="tab-content">
  <div role="tabpanel" class="tab-pane fade" aria-labelledby="home-tab" id="banki">
    <div class="tab-pane">
      <?php foreach ($banks as $key => $bank): ?>
        ...
        <div class="panel program_block">
          <a class="<?php print 'm_programs collapsed'; ?>" data-toggle="collapse" data-parent=".tab-pane" href="#collapse<?php print $key; ?>">Ипотечные программы банка<?php print $img_bt; ?>
          </a>
              ...
              <table class="bank-table">
                ...
                <?php foreach ($bank['program'] as $mortgage): ?>
                  ...
                  <tr>
                    ...
                    <?php else: ?>
                      <td class="td-button modal_mortgage_request"  data-toggle="modal" data-target=".registration">отправить заявку</td>
                    <?php endif; ?>
                  </tr>
  ...
  <div class="tab-pane fade active in" id="iprog" role="tabpanel" aria-labelledby="profile-tab">
    <?php $i = 0;?>
