<div class="container fin">
  <div class="col-xs-12">
    <div class="col-xs-3 zero-padding new-filter-container">
      <h3>Квартир <br>от застройщика<span><?php print $apartment_count; ?></span></h3>
    </div>
    <table class="table issue-table display" id="example" style="padding: 10px;">
      ...
      <?php if($apartments):?>
        <?php foreach($apartments as $apartment):?>
          ...
          <td class="anchor link" onClick='location.href="<?php print $apartment['complex_path']?>"' title="перейти на страницу жк">
            <?php print $apartment['complex']?>
          </td>
          <td class="anchor realty-appartment-info" data-toggle="modal" data-target=".flat_modal" data-id="<?php print $apartment['nid']; ?>">
            <?php print $apartment['section']?>
          </td>
          <td class="anchor" data-toggle="modal" data-target=".flat_modal" data-id="<?php print $apartment['nid']; ?>">
